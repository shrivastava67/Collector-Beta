...
def load_configuration(config_file):
    ...
    try:
        ...
        if not config.has_section('General'):
            raise ValueError("Missing 'General' section in config.ini")
...
def main():
    try:
        ...
        # Access database configuration settings
        ...
        ldap_enabled = config.getboolean('Authentication', 'ldap_enabled')
        ldap_server = config.get('Authentication', 'ldap_server')
        global_auth_enabled = config.getboolean('Authentication', 'global_auth_enabled')
